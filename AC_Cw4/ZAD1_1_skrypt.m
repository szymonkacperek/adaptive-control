...
%       Temat jest do zrobienia, ale bez wiedzy z wyk³adu mo¿e mi byæ ciê¿ko
%       zrozumieæ idee i przekszta³cenia matematyczne. Na ten moment potrzeba
%       wyznaczyæ (chyba) regresor i wektor parametrów.
% 19/05 Regresor wyznaczony. Wektor parametrów równie¿
% 19/05 W pliku inicjalizacyjnym nie mo¿e pojawiæ siê komenda 'clear all'.
%       Skutkuje to wyczyszczeniem zmiennych i estymacja nie mo¿e nast¹piæ
%       poprawnie.
% 19/05 Dlaczego regresor musi mieæ ujemne wartoœci dla y(n-1), y(n-2)?
...
%----   Ponownie przeprowadziæ identyfikacjê parametryczn¹ obiektu metod¹ RLS
%----   i przeanalizowaæ zbie¿noœæ estymat p?(n).
